...
@parent
 ...
 <caption>{{ __("Show class ':classname'", ['classname'=>$classname]) }}</caption>
 <thead>
  <tr>
   <th>{{ __('Key') }}</th>
   <th>{{ __('Value') }}</th>
 ...
 <tbody>
  <tr>
   <td>{{ __('Class name') }}</td>
   <td>{!! display_variable($classname) !!}</td>
  </tr>
  <tr>
 ...
 <table class="table is-bordered is-striped is-hoverable">
 <caption>{{ __("Show propeties of class ':classname'", ['classname'=>$classname]) }}</caption>
 <thead>
  <tr>
   <th>{{ __('Name') }}</th>
